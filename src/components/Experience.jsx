          ...
          <div className="relative max-w-4xl mx-auto mb-20">
            ...
            <div
              className={`absolute left-4 md:left-1/2 transform md:-translate-x-px top-0 bottom-0 w-0.5 ${
                darkMode ? 'bg-dark-100' : 'bg-gray-200'
              }`}
            />
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={`absolute left-4 md:left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full flex items-center justify-center z-10 bg-gradient-to-br ${gradient} shadow-lg`}
                  >
                  ...
                  >
                    ...
                    >
                      {/* Period Badge */}
                      <span
                        className={`inline-block px-3 py-1 rounded-full text-xs font-semibold mb-4 bg-gradient-to-r ${gradient} text-white`}
                      >
                        {item.period}
                      </span>
